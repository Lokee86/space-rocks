module Internal
  class BaseController < ApplicationController
    ...
    def authenticate_internal_request!
      ...
      return head :unauthorized unless provided_token
      return head :unauthorized unless expected_token.length == provided_token.length
      return head :unauthorized unless ActiveSupport::SecurityUtils.secure_compare(expected_token, provided_token)
    end
