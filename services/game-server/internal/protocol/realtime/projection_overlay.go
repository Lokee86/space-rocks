...
func ProjectOverlayLane(snapshot game.GameplayPresentationSnapshot, receiverPlayerID string) OverlayLaneProjection {
	...
	return OverlayLaneProjection{
		Receiver: OverlayReceiverRecord{
			...
			Health:                     receiverShip.Health,
			MaxHealth:                  receiverSession.MaxHealth,
			Shields:                    receiverShip.Shields,
			MaxShields:                 receiverSession.MaxShields,
			ShieldModuleID:             receiverSession.ShieldModuleID,
			ArmorModuleID:              receiverSession.ArmorModuleID,
			EngineModuleID:             receiverSession.EngineModuleID,
			UtilityModuleID:            receiverSession.UtilityModuleID,
