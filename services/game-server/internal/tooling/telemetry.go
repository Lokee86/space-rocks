...
func (controller *Controller) TelemetrySnapshot(context networkingtooling.Context) (protocol.TelemetrySnapshot, error) {
	...
	metrics := map[string]any{
		...
		"server_resident_set_bytes":      process.ResidentSetBytes,
		"server_peak_resident_set_bytes": process.PeakResidentSetBytes,
		"server_cpu_user_time_nanos":     process.CPUUserTimeNanos,
		"server_cpu_system_time_nanos":   process.CPUSystemTimeNanos,
		"server_cpu_utilization_cores":   process.CPUUtilizationCores,
		"server_goroutines":              process.Goroutines,
		"server_gc_cycles":               process.GCCycles,
		"server_gc_pause_total_nanos":    process.GCPauseTotalNanos,
		"server_gc_pause_window_nanos":   process.GCPauseWindowNanos,
		"server_gc_last_pause_nanos":     process.GCLastPauseNanos,
