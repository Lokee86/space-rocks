...
func TestResolveArcadeSurvivalBaseline(t *testing.T) {
	...
	if resolved.PlayerSpawnProfileID != lives.DefaultSpawnProfileID || len(resolved.EncounterSpawnProfileIDs) != 1 {
...
func TestResolveInfiniteLives(t *testing.T) {
	...
	if resolved.LivesPolicy.Model != lives.LifeModelInfinite {
