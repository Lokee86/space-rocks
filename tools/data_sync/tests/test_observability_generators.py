...
def test_observability_generators_are_deterministic_and_complete() -> None:
    ...
    assert len(payload["events"]) == len(contract.events) == 161
    ...
    assert "document_type: generated" in docs_output
    assert "policy_exempt_reason: Generated by data-sync." in docs_output
