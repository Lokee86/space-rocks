...
pushd services/diagnostic-aggregator >/dev/null
run_stage "diagnostic-aggregator" go test -buildvcs=false ./...
popd >/dev/null
...
run_stage "game-server localpackage" go test -tags localpackage -buildvcs=false ./...
popd >/dev/null
