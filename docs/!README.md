...
- Normal documentation folders use `!README.md` as the folder index.
...
This index intentionally stays short. Folder-specific details belong in the owning `!README.md` files.