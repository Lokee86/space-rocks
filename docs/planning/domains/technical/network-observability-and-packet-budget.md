...
- Non-hot world and ship/bullet lifecycle changes can force related hot emission and projection advancement. Chunked asteroid lifecycle and its related projection/hot transition remain aligned to the permitted asteroid cadence tick.
