...
Legacy source-of-truth docs were used as migration material only. Current authority comes from current source files, generated outputs, service implementations, tests, and the current data documentation.
