...
This folder owns the service documentation indexes for current Space Rocks services.

## Does Not Belong

- Domain flow docs.
- Planning docs.
- Direct code maps outside a service-specific index.
...
Service docs stay focused on ownership, runtime responsibility, and implementation boundaries.