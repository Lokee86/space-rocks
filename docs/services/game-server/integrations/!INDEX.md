...
- [diagnostic-aggregator-hosting.md](diagnostic-aggregator-hosting.md) - Optional game-server in-process hosting boundary for the independent diagnostic-aggregator service.
