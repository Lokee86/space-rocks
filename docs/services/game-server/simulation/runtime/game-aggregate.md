...
Pending events, realtime session state, baselines, sequences, delta history, cadence, and encoded packets remain receiver-specific and are not shared by the presentation frame.
