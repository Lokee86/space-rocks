...
func test_player_data_profile_path_returns_development_data_handler_url() -> void:
...
func test_packaged_player_data_base_url_uses_ipv4_loopback() -> void:
	assert_eq(ApiConfig.player_data_base_url_for_runtime(true), "http://127.0.0.1:8080")
