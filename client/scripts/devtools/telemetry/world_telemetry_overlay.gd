...
func _append_server_lines(lines: PackedStringArray, metrics: Dictionary) -> void:
	...
	lines.append("resident_set_bytes: %s" % _count_value(metrics, "server_resident_set_bytes"))
	lines.append("peak_resident_set_bytes: %s" % _count_value(metrics, "server_peak_resident_set_bytes"))
	lines.append("cpu_cores: %s" % _decimal_value(metrics, "server_cpu_utilization_cores"))
	...
	lines.append("gc_pause_window_ns: %s" % _count_value(metrics, "server_gc_pause_window_nanos"))
	lines.append("gc_last_pause_ns: %s" % _count_value(metrics, "server_gc_last_pause_nanos"))
	lines.append("")
